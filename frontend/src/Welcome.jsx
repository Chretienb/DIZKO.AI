...
const FEATURES = [
  {
    ...
    icon: (
      <svg width={22} height={22} viewBox="0 0 24 24" fill="none"
        stroke="rgba(255,255,255,.7)" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ width:'100%', maxWidth:480, display:'flex', flexDirection:'column', alignItems:'center', gap:0 }}>
        ...
        <div style={{
          ...
          <img src={logo} alt="" style={{ width: 80, height: 80, borderRadius: 22,
            objectFit: 'cover', boxShadow: '0 0 0 1px rgba(255,255,255,.07), 0 20px 50px rgba(244,147,122,.2)' }} />
          {/* Green check badge */}
          <div style={{
        ...
        {/* Subheading */}
        <p style={{
          margin:'0 0 36px', fontSize:15, color:'rgba(255,255,255,.4)',
        ...
        {/* Fine print */}
        <p style={{
          marginTop:16, fontSize:11.5, color:'rgba(255,255,255,.2)', textAlign:'center',
