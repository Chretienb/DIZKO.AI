  ...
  return (
    <div style={{ background:'#fff', borderRadius:16, padding:'12px 18px', marginBottom:20, boxShadow:'0 1px 3px rgba(0,0,0,.05)', border:'1px solid rgba(0,0,0,.06)', display:'flex', alignItems:'center', gap:12 }}>
      ...
      <div style={{ flex:1, display:'flex', alignItems:'center', gap:10 }}>
        ...
        <div aria-hidden="true" style={{ width:5, height:5, borderRadius:'50%', flexShrink:0, background:beatFlash?'#111':'rgba(0,0,0,.12)', transition:beatFlash?'none':'all .2s' }}/>
      </div>
        ...
        {!isMobile && (
          <div style={{ display:'flex', alignItems:'center', background:'rgba(0,0,0,.03)', border:'1px solid rgba(0,0,0,.08)', borderRadius:10, overflow:'hidden', height:34 }}>
            <button onClick={() => onBpmChange(bpm-1)} disabled={bpm<=40} aria-label="Decrease BPM"
              style={{ width:28, height:'100%', border:'none', background:'transparent', cursor:bpm<=40?'default':'pointer', color:bpm<=40?'#ddd':'#888', fontSize:16, display:'flex', alignItems:'center', justifyContent:'center' }}>−</button>
            ...
            <button onClick={() => onBpmChange(bpm+1)} disabled={bpm>=250} aria-label="Increase BPM"
              style={{ width:28, height:'100%', border:'none', background:'transparent', cursor:bpm>=250?'default':'pointer', color:bpm>=250?'#ddd':'#888', fontSize:16, display:'flex', alignItems:'center', justifyContent:'center' }}>+</button>
          </div>
        )}
