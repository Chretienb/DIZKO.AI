...
// Compact dashboard switch: flip it to OPEN your public producer page. It
// rests OFF while you're in the app — coming back from your public page
// leaves it left. Every profile is public once a handle is claimed.
export default function PublicProfileToggle() {
  ...
  return (
    <div style={{ display:'inline-flex', alignItems:'center', gap:10 }}>
      ...
      <button onClick={open} aria-label="Open public profile"
        style={{ width:42, height:24, borderRadius:12, border:'none', cursor:'pointer', position:'relative', flexShrink:0,
          background: on ? C.coral : 'rgba(var(--fg),.18)', transition:'background .2s' }}>
